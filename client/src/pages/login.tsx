    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 page-enter">
      <Card className="w-full max-w-md" data-testid="login-card">
        <CardHeader className="text-center space-y-4 pb-2">
          ...
          <p className="text-sm text-muted-foreground">Sign in to your family hub</p>
        </CardHeader>
        <CardContent>
          <form
          ...
          >
            {error && (
              <div className="text-sm text-destructive text-center" data-testid="login-error">{error}</div>
            )}
