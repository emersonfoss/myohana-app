    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 page-enter">
      <Card className="w-full max-w-md" data-testid="register-card">
        <CardHeader className="text-center space-y-4 pb-2">
          ...
          <p className="text-sm text-muted-foreground">Start your family's private space</p>
        </CardHeader>
        <CardContent>
          <form
          ...
          >
            {error && (
              <div className="text-sm text-destructive text-center" data-testid="register-error">{error}</div>
            )}
